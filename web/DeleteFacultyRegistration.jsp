...
<h1 align="center">Delete Faculty Registration Form</h1>
<div class="register">
<h2>Register here</h2>
<form id="register" method="post" name="f" action="DeleteFaculty.jsp">
...
<select id="desig" name="desig" value="<%=rs.getString(5)%>">
...
<select id="state" required="" name="male" value="<%=rs.getString(7)%>">
    <option>Male</option>
    <option>Female</option>
    <option>Others</option>
</select><br><br>
<label>Phone Number</label><br>
<input type="number" name="MNum" id="num" placeholder="Enter mobile number" required="" value="<%=rs.getString(8)%>"><br><br>
...
<input type="password" name="pass" id="name" placeholder="Enter password" required="" value="<%=rs.getString(11)%>"><br><br>
<label>Re-type Password</label><br>
<input type="password" name="repass" id="name" placeholder="Re-Enter password" required="" value="<%=rs.getString(12)%>"><br><br>
<label>Photo</label><br>
<input type="file" name="photo" id="name" value="<%=rs.getString(13)%>"><br><br>
<input type="checkbox" id="check" required=""/><label>  I Accept Terms and Conditions</label><br><br>
<input type="submit" value="Delete" id="sub" required="" onclick="checkpassword()">
