...
<form id="register" method="post" name="f" >
   ...
   <% 
       ...
       Statement st=con.createStatement();
                    ResultSet rs=st.executeQuery("select * from student_registration where facultyid='"+k+"'");
                    while(rs.next()){
...
<input type="text" name="dept" id="name"  value="<%=rs.getString(4)%>"><br><br>

<label>State</label><br>
<input type="text" id="state" name="state" value="<%=rs.getString(13)%>"><br><br>

<label>Date Of Birth</label><br>
<input type="text" name="date" id="name" placeholder="Enter date of birth" required="" value="<%=rs.getString(5)%>"><br><br>

<label>Gender</label><br>
<input type="text" name="male" id="name" value="<%=rs.getString(6)%>"><br><br>

<label>Phone Number</label><br>
<input type="text" name="MNum" id="num" placeholder="Enter mobile number" required="" value="<%=rs.getString(7)%>"><br><br>
...
<input type="password" name="repass" id="name" placeholder="Re-Enter password" required="" value="<%=rs.getString(11)%>" readonly="<%=rs.getString(11)%>"><br><br>
